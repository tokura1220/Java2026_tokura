...
public class WebDriverUtils {
	...
	public static void pageLoadTimeout(int second) {
		wd.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(second));
	}
	...
	public static void scrollBy(String pixel) {
		((JavascriptExecutor) wd).executeScript("window.scrollBy(0," + pixel + ");");
	}
	...
	public static void scrollTo(String pixel) {
		((JavascriptExecutor) wd).executeScript("window.scrollTo(0," + pixel + ");");
	}
