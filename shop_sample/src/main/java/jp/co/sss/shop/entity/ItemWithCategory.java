...
import jakarta.persistence.NamedQuery;  //8章 ソースコード8-1 追加
import jakarta.persistence.SequenceGenerator;
import jakarta.persistence.Table;

@Entity
@Table(name = "items_with_categories")
@NamedQuery(name="findByIdNamedQuery", query="SELECT i FROM ItemWithCategory i WHERE i.id = :id") //8章 ソースコード8-1 追加
